 ...
 * @author Ali Erkin
 */
public class MusteriParaGonder extends javax.swing.JFrame {
    ...
    private void onaylaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_onaylaActionPerformed
        ...
        ResponseModel responseModel = accountService.paraGonder(list.get(jComboBox1.getSelectedIndex()),miktar.getText(),iban.getText());
        if(responseModel.isSuccess()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MusteriParaGonder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
