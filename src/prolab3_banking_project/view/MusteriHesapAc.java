 ...
 * @author erene
 */
public class MusteriHesapAc extends javax.swing.JFrame {

    /**
     * Creates new form MusteriHesapAc
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MusteriHesapAc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
