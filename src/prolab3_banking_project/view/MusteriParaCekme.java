 ...
 * @author erene
 */
public class MusteriParaCekme extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MusteriParaCekme.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
